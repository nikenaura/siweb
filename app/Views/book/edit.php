                ...
                <form action="<?= base_url('book/edit/' .  $result['book_id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            ...
                            value="<?=old('release_year', $result['release_year']) ?>">
                        </div>
                            <label for="stock" class="col-sm-2 col-form-label">Stok</label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="stock"
                                name="stock" value="<?= old('stock', $result['stock']) ?>">
                            </div>
                        </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="col-sm-3">
                                ...
                                value="<?= old('discount', $result['discount']) ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="cover" class="col-sm-2 col-form-label">Cover</label>
                            ...
                            <div class="col-sm-3">
                                <select type="text" class="form-control" id="book_category_id"
