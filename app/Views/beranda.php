...
<script>
    ...
    //  ================================================== PEMBELIAN ==================================================
    function setLineChart2(dataset) {
        // Area Chart Example
    ...
    function setPieChart(dataset) {
        ...
        var myPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataset,
                    backgroundColor: ['#007bff', '#dc3545', '#ffc107', '#28a745', '#2890a7', '#a7284c', '#9fa728', '#28a75d', '#2837a7', '#a73728', '#a7a728', '#28a757'],
                }],
            },
        });
    }
